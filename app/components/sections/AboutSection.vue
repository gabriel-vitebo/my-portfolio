<template>
  <section id="about" class="grid min-h-screen snap-start place-items-center bg-background px-4 py-24 sm:px-6">
...
import type { AboutData, SocialLink } from '~/types/portfolio'
